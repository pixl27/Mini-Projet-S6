...
<h3 class="title">Modifier Video</h3>

<form action="<?php echo base_url();?>ModifierAction" data-ajax="false" enctype="multipart/form-data" accept-charset="utf-8"  method="POST">
...
<input class="form-control input-box"   type="text" name="name" value="<?php echo $value['Nom'];?>" placeholder="Your Name" autocomplete="off">


<div class="sort-by-select">
<input type="text" name ="langue" style="width:250px;" value="<?php echo $value['Langue'];?>" />

</div>
<div class="sort-by-select">
<input type="text" name ="categorie" style="width:250px;" value="<?php echo $value['Categorie'];?>" />
</div>
<in>
<div>
  <input style="width:250px;" value="<?php echo $value['DateAjout'];?>"   type="text" name="dateajout" placeholder="dateajout" id="datepicker">
  <input style="width:250px;"  value="<?php echo $value['DateSortie'];?>"   type="text" name="datesortie" placeholder="datesortie"  id="datepicker1">
</div>
<h6>Description </h6>
<div>
  <input style="width:250px;height:100px;" value="<?php echo $value['Description'];?>" type="text" name="description" placeholder="description" id="">

</div>
<h6>Notes </h6>
<div>
  <input style="width:250px;"  value="<?php echo $value['Note'];?>"  type="text" name="note" placeholder="Note" id="">

</div>
<h6>Lien Trailer </h6>
<div>
  <input style="width:250px;"  value="<?php echo $value['Lien'];?>"   type="text" name="lien" placeholder="trailer" id="">

</div>
<h6>Lien Streaming </h6>
<div>
  <input style="width:250px;"  value="<?php echo $value['Streaming'];?>"  type="text" name="streaming" placeholder="streaming" id="">

</div>
<h6>Poster </h6>

<input type="file"  value="<?php echo $value['Image'];?>" name="upload" />
<input type="hidden" value="<?php echo $value['Image'];?>" name="image"/>
<h6>Background </h6>

<input type="file"  value="<?php echo $value['Background'];?>"  name="background" value="background" />
<input type="hidden" value="<?php echo $value['Background'];?>" name="back"/>
...
<button class="btn btn-main btn-effect" type="submit">Modifier</button>
</div>
<?php } ?>
</form>
