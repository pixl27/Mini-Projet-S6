...
<in>
<div>
  <input style="width:250px;"   type="text" name="datedebut" placeholder="Datedebut" id="datepicker">
  <input style="width:250px;"   type="text" name="datefin" placeholder="Datefin"  id="datepicker1">
</div>
<h6>Notes Entre : </h6>
<div>
  <select name="notemin" style="width:250px;" class="chosen-select-no-single">
  <?php   for ($i=0; $i<=20; $i++) {   ?>
<option value="<?php echo $i;?>"><?php echo $i;?></option>
<?php } ?>
  </select>
  <select name="notemax" style="width:250px;" class="chosen-select-no-single">
  <?php   for ($i=0; $i<=20; $i++) {   ?>
<option value="<?php echo $i;?>"><?php echo $i;?></option>
<?php } ?>
  </select>
